...
/**
 * Serializable là annotation từ thư viện Kotlinx Serialization, được sử dụng để đánh dấu một lớp dữ liệu có thể được chuyển đổi giữa các định dạng như JSON, ProtoBuf, v.v.
 */
@Serializable
